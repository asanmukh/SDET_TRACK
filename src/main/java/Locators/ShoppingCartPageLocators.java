...
public interface ShoppingCartPageLocators {
    ...
    By deleteItemFromCart = By.xpath("(//*[@data-feature-id='delete'])[1]/span/input");
    By itemDeletedSuccessMessage = By.xpath("//*[text()=' was removed from Shopping Cart. ']");
    By deleteAllItemsFromCart = By.xpath("//*[@data-feature-id='delete']/span/input[@data-action='delete']");
